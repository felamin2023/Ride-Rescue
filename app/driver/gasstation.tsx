    ...
    >
      ...
      <View style={{ flex: 1, backgroundColor: "rgba(0,0,0,0.45)" }}>
        ...
        >
          ...
          {/* Actions (no Message; Open in Maps + Copy) */}
      ...
      >
        <Pressable onPress={() => {}}>
          ...
          >
            ...
            {/* Single full-width Open in Maps button */}
            <View className="mt-4">
              <PrimaryButton
                label="Open in Maps"
                icon="navigate-outline"
    ...
    >
      <View className="flex-row items-start gap-3">
        ...
        <View className="flex-1">
          ...
          {/* Buttons row — message removed; Open Location placed at the right position */}
...
export default function GasStationScreen() {
  ...
  const [filters, setFilters] = useState<FilterKey[]>(["gas"]);
